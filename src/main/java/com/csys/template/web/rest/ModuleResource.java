...
public class ModuleResource {
     ...
     * new module, or with status 400 (Bad Request) if the module has already an
     * ID
     ...
     * module, or with status 400 (Bad Request) if the module is not valid, or
     * with status 500 (Internal Server Error) if the module couldn't be updated
     * @throws org.springframework.web.bind.MethodArgumentNotValidException
     */
    @PreAuthorize("hasRole('ROLE_ADMIN')")
     ...
     * @return the ResponseEntity with status 200 (OK) and with body of module,
